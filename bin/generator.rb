...
Generator = Generator.new(options).build do |xml, scale, banner_y, ykyk_fill|
...
File.write('images/sswe.svg', Generator.to_xml)
...
File.write('images/jswe.svg', Generator.to_xml)
...
File.write('images/pswe.svg', Generator.to_xml)
